        ...
        <div className="w-full max-w-sm space-y-8 flex flex-col items-center">
          ...
          <div className="relative w-full flex flex-col items-center">
            ...
            <div className="bg-white border-2 border-dashed border-black rounded-[2rem] px-4 py-5 w-full text-center z-10 -mt-1">
              ...
              <img src="https://i.ibb.co/SwcnhdnN/bonus1.png" alt="Plano Alimentar Anti-Inflamação" className="w-full h-auto my-0 object-contain scale-110 transform origin-center" />
          ...
          <div className="relative w-full flex flex-col items-center">
            ...
            <div className="bg-white border-2 border-dashed border-black rounded-[2rem] px-4 py-5 w-full text-center z-10 -mt-1">
              ...
              <img src="https://i.ibb.co/LD5m2B12/bonus2.png" alt="Guia de Exames do Fígado" className="w-full h-auto my-0 object-contain scale-110 transform origin-center" />
              <div className="text-base md:text-lg font-bold mb-2 leading-tight mt-0">
                <span className="text-black">DE: </span>
                <span className="text-red-600 line-through">R$ 47</span><br/>
                <span className="text-black">HOJE: </span>
          ...
          <div className="relative w-full flex flex-col items-center">
            ...
            <div className="bg-white border-2 border-dashed border-black rounded-[2rem] px-4 py-5 w-full text-center z-10 -mt-1">
              ...
              <img src="https://i.ibb.co/vxHN3LHy/bonus3.png" alt="Cardápio de Emergência" className="w-full h-auto my-0 object-contain scale-110 transform origin-center" />
              <div className="text-base md:text-lg font-bold mb-2 leading-tight mt-0">
                <span className="text-black">DE: </span>
                <span className="text-red-600 line-through">R$ 47</span><br/>
                <span className="text-black">HOJE: </span>
